...
const ALLOWED_ROLES = ["admin", "recepcion", "especialista", "administrativo", "dueno", "promotor", "enfermera", "intendencia", "mantenimiento", "asistente_admin", "contador", "rrhh", "empleado"] as const;
