...
const APPS = [
  ...
  { key: "req-medicamentos", label: "Requisición de medicamentos", desc: "Solicitudes de insumos médicos", icon: ShoppingBag },
  { key: "req-limpieza", label: "Requisición de limpieza", desc: "Insumos de intendencia", icon: Sparkles },
  { key: "req-mantenimiento", label: "Requisición de mantenimiento", desc: "Insumos y servicios", icon: Wrench },
  { key: "pago-proveedores", label: "Pago a proveedores", desc: "Órdenes y verificación con PIN", icon: HandCoins },
