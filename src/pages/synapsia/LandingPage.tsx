    ...
    <div className="min-h-screen bg-background flex flex-col">
      <header className="border-b bg-card">
        <div className="max-w-5xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-bold">Synapsia</h1>
              <p className="text-xs text-muted-foreground">Sistema de Gestión Clínica</p>
            </div>
          </div>
          <Link to="/synapsia/login" className="px-4 py-2 bg-primary text-primary-foreground rounded-lg text-sm font-medium hover:opacity-90">
            Iniciar Sesión
          </Link>
        </div>
      </header>
      ...
      <main className="flex-1 flex items-center justify-center">
        <div className="max-w-3xl mx-auto px-4 py-16 text-center space-y-8">
          ...
          <h2 className="text-3xl font-bold">Sistema de Gestión Clínica</h2>
