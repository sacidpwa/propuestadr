            ...
            <>
              {gcalConnected ? (
                <button
                  ...
                  className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-md border border-green-300 bg-green-50 text-green-700 text-xs font-medium hover:bg-green-100 transition-colors cursor-pointer"
